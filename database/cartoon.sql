...
--
-- Host: 127.0.0.1    Database: cartoon
-- ------------------------------------------------------
...
CREATE TABLE `cart_item` (
  ...
  CONSTRAINT `cart_item_ibfk_1` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`user_id`),
...
--
-- Dumping events for database 'cartoon'
--
...
-- Dump completed on 2025-06-13 19:32:21
